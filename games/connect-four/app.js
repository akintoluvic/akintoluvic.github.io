document.addEventListener('DOMContentLoaded', () => {
    ...
    for(var i = 0; i < squares.length; i++)
        ...
        (function(index){
            ...
            squares[i].onclick = function(){
                // if the square below your current square is taken, you can go ontop it
    ...
    function checkBoard() {
        // make const that shows all winning array
        const winningArrays = [
        ...
        for(let y = 0; y < winningArrays.length; y++){
            ...
            if(square1.classList.contains('player-one') &&
                ...
                square4.classList.contains('player-one')) {
                    // if they do, player-one is passed in as the winner
    ...
    // event listener to checkBoard fn on each click
